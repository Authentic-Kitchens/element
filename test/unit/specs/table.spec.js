...
describe('Table', () => {
  ...
  describe('column attributes', () => {
    ...
    it('formatter', (done) => {
      const vm = createTable(':formatter="renderCell"', '', '', '', {
        methods: {
    ...
    describe('sortable', () => {
      ...
      it('sortable by method', (done) => {
        const vm = createTable('sortable :sort-by="sortBy"', '', '', '', {
          methods: {
            sortBy(a) {
              return -a.runtime
            }
      ...
      it('sortable by property', (done) => {
        const vm = createTable('sortable sort-by="runtime"', '', '', '', {})
